export const MINT_DAPPY = `
          ...
          transaction(templateID: UInt32, amount: UFix64) {
            ...
            prepare(acct: AuthAccount) {
              self.receiverReference = acct.borrow<&DappyContract.Collection>(from: DappyContract.CollectionStoragePath) ?? panic ("Cannot Borrow")
              let vaultRef = acct.borrow<&FUSD.Vault>(from: /storage/fusdVault) ?? panic ("Cannot Borrow from FUSD vault")
